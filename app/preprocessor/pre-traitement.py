...
def save_to_hive(df, table_name="hive.preprocessed_accidents_cleaned"):
...
def inspect_last_bronze_traitement_and_save(spark):
    ...
    try:
        ...
        colonnes_a_supprimer = ["Description", "situation_date","Airport_Code", "Source", "Street","City","Country", "County"]
